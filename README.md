...
- **[Suede Creator Skills](https://github.com/JasonColapietro/suede-creator-skills): 76 open-source agent skills for Claude Code and Codex**, installable as a plugin marketplace, and accepted into [14 independent skills directories](#skills-directories-the-pack-was-accepted-into) — GitHub's own awesome-copilot among them. Every acceptance links to its merged pull request.
...
[Suede Creator Skills](https://skills.suedeai.ai) has been reviewed and merged into fourteen independent skill and plugin catalogs that I do not maintain. Every row links to the merged pull request.
...
- **Sep 7** · [Suede Creator Skills](https://github.com/JasonColapietro/suede-creator-skills) accepted into [awesome-claude-code](https://github.com/ichangyou/awesome-claude-code/pull/9), the fourteenth skills directory.
