...
<p>
  ...
  <a href="https://suedeai.ai"><img src="https://img.shields.io/badge/Suede_Labs_AI-suedeai.ai-0369a1?labelColor=080808" alt="Suede Labs AI: suedeai.ai"></a>
...
Counts are as of September 16, 2026. Most lines link to a record somebody else hosts.
...
- **45 pull requests merged into 41 open-source projects I don't maintain.** Jest, Adobe React Spectrum, Backstage, Hardhat, Polkadot SDK, Cosmos SDK, CoreOS Ignition, Solana Pay, elizaOS, x402, zeroclaw, and the Prometheus docs are among them. 27 are fixes, features, tests, and docs; the other 18 are accepted listings of Suede projects on third-party lists. Outside GitHub, a Linux kernel USB/IP patch series is public upstream at v6 on the kernel's own lists, recorded separately under [Open source](#open-source). [Check all 45 merged pull requests on GitHub](https://github.com/search?q=is%3Apr+author%3AJasonColapietro+is%3Amerged+-user%3AJasonColapietro+-user%3ASuede-AI&type=pullrequests).
- **A USB/IP patch series submitted to the Linux kernel**, revised in public from v2 through v6 on the kernel's own mailing lists at [lore.kernel.org/linux-usb](https://lore.kernel.org/linux-usb/). Five rounds of maintainer review, in the open, on the least forgiving list in open source. It sits outside the pull-request count above; the record is at [seo.suedeai.ai/evidence#open-source](https://seo.suedeai.ai/evidence#open-source).
...
- **Scaled Suede AI to a roughly $28 million peak valuation.** Stated on the [founder page](https://suedeai.ai/founder).
...
|---|---|
| [Suede Labs AI](https://suedeai.ai) | The product front door. Creator ownership infrastructure for registering work and likeness, documenting provenance, licensing rights, and routing royalties. |
...
Third-party outlets that have covered Jason Colapietro and Suede Labs AI, newest first: eleven placements across five outlets.
...
- **Aug 8** · [Suede Market Maker](https://github.com/Suede-AI/suede-market-maker): rebuilt the dashboard as a proper control desk, on documented tokens instead of ad-hoc styling. Still free, still courtesy of Suede Labs AI.
