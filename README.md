...
- **A USB/IP patch series submitted to the Linux kernel**, revised through v6 in public on the kernel's own mailing lists at [lore.kernel.org/linux-usb](https://lore.kernel.org/linux-usb/). Kernel review is the least forgiving review there is, and the thread is open for anyone to read. It sits outside the pull-request count above; the record is at [seo.suedeai.ai/evidence#open-source](https://seo.suedeai.ai/evidence#open-source).
