...
- **[Suede Creator Skills](https://github.com/JasonColapietro/suede-creator-skills): 76 open-source agent skills for Claude Code and Codex**, installable as a plugin marketplace, and accepted into 14 independent skills directories.
...
- **Took the $SUEDE token to a roughly $28 million peak fully diluted valuation.** $SUEDE is Suede Labs AI's token on Solana, and it anchors the rewards program on [suedeai.ai](https://suedeai.ai). Stated on the [founder page](https://suedeai.ai/founder).
