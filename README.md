...
- **Six provisional patent applications** on file with the USPTO, including 63/947,120. The USPTO does not publish provisional applications, so these are filing records rather than granted patents, and no public record exists to link.
